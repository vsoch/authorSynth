...
def neurosynthMatch(papers):
    """Match neurosynth doi with papers doi"""
    dois = papers.keys()
    # NOT YET WRITTEN
    #TODO - 1) get list of dois from neuroSynth database
    #       2) return meta analysis with those dois!
    #       3) write function to output text / image result
    # https://github.com/neurosynth/neurosynth/blob/master/neurosynth/analysis/meta.py
    # https://github.com/neurosynth/neurosynth/blob/master/neurosynth/base/dataset.py
...
def getArticles(author,email):
    ...
    print "Getting pubmed articles for author " + searchTerm
